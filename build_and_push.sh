#!/bin/sh
#this file bypasses getting from docker or artifact and goes right to github
...
docker buildx build --platform linux/arm64 --build-arg "PROJECT_VERSION=${PROJECT_VERSION}" --tag "infernocommunity/inferno-resource-validator:${PROJECT_VERSION}" --tag infernocommunity/inferno-resource-validator:latest --load .