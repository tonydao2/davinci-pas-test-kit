...
module DaVinciPASTestKit
  module DaVinciPASV221
    class PASServerApprovalUseCaseGroup < Inferno::TestGroup
      id :pas_server_v221_approval_use_case
      ...
      group do
        title "Server can respond with 'Approval' to claims submitted for prior authorization"
        
        test from: :pas_server_request_bundle_validation_test do
          id :pas_server_v221_pas_request_bundle_validation_test_approval
        ...
        test from: :pas_claim_submit_operation_test do
          id :pas_v221_claim_submit_operation_test_approval
          config(
            inputs: {
        ...
        test from: :pas_server_response_bundle_validation_test do
          id :pas_server_v221_pas_response_bundle_validation_test_approval
        ...
        test from: :prior_auth_claim_response_decision_validation do
          ...
          title "Server response includes the 'Approval' decision code in the ClaimResponse instance"
          config(
            options: {
              use_case: 'approval',
              operation: 'submit'
